...
//         std::make_unique<sb::di::details::ExternalService<TestInheritClass5>>(&test)};
...
//     const sb::di::ServiceInstance
//     external{std::make_unique<sb::di::details::ExternalService<TestInheritClass5>>(test)};
//
