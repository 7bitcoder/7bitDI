...
class MultiInheritanceUniqFactoryKeyedTest : public testing::Test
{
  protected:
    static void SetUpTestSuite() {}

    MultiInheritanceUniqFactoryKeyedTest() {}

    void SetUp() override {}

    void TearDown() override {}

    ~MultiInheritanceUniqFactoryKeyedTest() override = default;

    static void TearDownTestSuite() {}
};

TEST_F(MultiInheritanceUniqFactoryKeyedTest, ShouldTryGetService)
{
    sb::di::ServiceProviderOptions options;
    options.checkServiceGlobalUniqueness = false;
    auto provider =
        sb::di::ServiceCollection{}
            .addKeyedSingleton<TestMultiInheritClass1>("key", [] { return std::make_unique<TestMultiInheritClass2>(); })
            .addKeyedSingleton<TestMultiInherit2Class1>("key",
                                                        [] { return std::make_unique<TestMultiInheritClass2>(); })
            .addKeyedTransient<TestMultiInheritClass2>("key", [] { return std::make_unique<TestMultiInheritClass3>(); })
            .addKeyedTransient<TestMultiInherit3Class1>("key",
                                                        [] { return std::make_unique<TestMultiInheritClass3>(); })
            .addKeyedScoped<TestMultiInheritClass3>("key", [] { return std::make_unique<TestMultiInheritClass4>(); })
            .addKeyedScoped<TestMultiInherit4Class4>("key", [] { return std::make_unique<TestMultiInheritClass4>(); })
...
TEST_F(MultiInheritanceUniqFactoryKeyedTest, ShouldTryGetOneLastServiceSingleton)
{
    auto provider =
        sb::di::ServiceCollection{}
            .addKeyedSingleton<TestMultiInherit2Class1>("key",
            ...
            .addKeyedSingleton<TestMultiInherit2Class1>("key",
                                                        [] { return std::make_unique<TestMultiInheritClass3>(); })
            .addKeyedSingleton<TestMultiInherit2Class1>("key",
                                                        [] { return std::make_unique<TestMultiInheritClass4>(); })
...
TEST_F(MultiInheritanceUniqFactoryKeyedTest, ShouldTryGetOneLastServiceScoped)
{
    auto provider =
        sb::di::ServiceCollection{}
            .addKeyedScoped<TestMultiInherit2Class1>("key", [] { return std::make_unique<TestMultiInheritClass2>(); })
            .addKeyedScoped<TestMultiInherit2Class1>("key", [] { return std::make_unique<TestMultiInheritClass3>(); })
            .addKeyedScoped<TestMultiInherit2Class1>("key", [] { return std::make_unique<TestMultiInheritClass4>(); })
            .buildServiceProvider();
...
TEST_F(MultiInheritanceUniqFactoryKeyedTest, ShouldGetService)
{
    sb::di::ServiceProviderOptions options;
    options.checkServiceGlobalUniqueness = false;
    auto provider =
...
TEST_F(MultiInheritanceUniqFactoryKeyedTest, ShouldGetOneLastServiceSingleton)
{
    auto provider =
        sb::di::ServiceCollection{}
            .addKeyedSingleton<TestMultiInherit2Class1>("key",
...
TEST_F(MultiInheritanceUniqFactoryKeyedTest, ShouldGetOneLastServiceScoped)
{
    auto provider =
        sb::di::ServiceCollection{}
            .addKeyedScoped<TestMultiInherit2Class1>("key", [] { return std::make_unique<TestMultiInheritClass2>(); })
...
TEST_F(MultiInheritanceUniqFactoryKeyedTest, ShouldGetServices)
{
    sb::di::ServiceProviderOptions options;
    options.checkServiceGlobalUniqueness = false;
    auto provider =
...
TEST_F(MultiInheritanceUniqFactoryKeyedTest, ShouldGetCastedServicesInOrder)
{
    auto provider =
        sb::di::ServiceCollection{}
            .addKeyedScoped<TestMultiInherit2Class1>("key", [] { return std::make_unique<TestMultiInheritClass2>(); })
...
TEST_F(MultiInheritanceUniqFactoryKeyedTest, ShouldGetServicesInOrderAfterNormalGet)
{
    auto provider =
        sb::di::ServiceCollection{}
            .addKeyedScoped<TestMultiInherit2Class1>("key", [] { return std::make_unique<TestMultiInheritClass2>(); })
...
TEST_F(MultiInheritanceUniqFactoryKeyedTest, ShouldTryCreateService)
{
    sb::di::ServiceProviderOptions options;
    options.checkServiceGlobalUniqueness = false;
    auto provider =
...
TEST_F(MultiInheritanceUniqFactoryKeyedTest, ShouldCreateService)
{
    sb::di::ServiceProviderOptions options;
    options.checkServiceGlobalUniqueness = false;
    auto provider =
...
TEST_F(MultiInheritanceUniqFactoryKeyedTest, ShouldNotCreateServiceInPlace)
{
    sb::di::ServiceProviderOptions options;
    options.checkServiceGlobalUniqueness = false;
    auto provider =
...
TEST_F(MultiInheritanceUniqFactoryKeyedTest, ShouldCreateServices)
{
    sb::di::ServiceProviderOptions options;
    options.checkServiceGlobalUniqueness = false;
    auto provider =
...
TEST_F(MultiInheritanceUniqFactoryKeyedTest, ShouldCreateServicesInOrder)
{
    auto provider =
        sb::di::ServiceCollection{}
            .addKeyedTransient<TestMultiInherit2Class1>("key",
                                                        [] { return std::make_unique<TestMultiInheritClass2>(); })
            .addKeyedTransient<TestMultiInherit2Class1>("key",
                                                        [] { return std::make_unique<TestMultiInheritClass3>(); })
            .addKeyedTransient<TestMultiInherit2Class1>("key",
