...
TEST_F(MultiInheritanceTest, ShouldTryGetService)
{
...
TEST_F(MultiInheritanceTest, ShouldTryGetOneLastServiceSingleton)
{
    auto provider = sb::di::ServiceCollection{}
                        .addSingleton<TestMultiInherit2Class1, TestMultiInheritClass2>()
                        .addSingleton<TestMultiInherit2Class1, TestMultiInheritClass3>()
                        .addSingleton<TestMultiInherit2Class1, TestMultiInheritClass4>()
...
TEST_F(MultiInheritanceTest, ShouldTryGetOneLastServiceScoped)
{
    auto provider = sb::di::ServiceCollection{}
                        .addScoped<TestMultiInherit2Class1, TestMultiInheritClass2>()
                        .addScoped<TestMultiInherit2Class1, TestMultiInheritClass3>()
                        .addScoped<TestMultiInherit2Class1, TestMultiInheritClass4>()
                        .buildServiceProvider();
...
TEST_F(MultiInheritanceTest, ShouldGetOneLastServiceSingleton)
{
    auto provider = sb::di::ServiceCollection{}
                        .addSingleton<TestMultiInherit2Class1, TestMultiInheritClass2>()
                        .addSingleton<TestMultiInherit2Class1, TestMultiInheritClass3>()
...
TEST_F(MultiInheritanceTest, ShouldGetOneLastServiceScoped)
{
    auto provider = sb::di::ServiceCollection{}
                        .addScoped<TestMultiInherit2Class1, TestMultiInheritClass2>()
                        .addScoped<TestMultiInherit2Class1, TestMultiInheritClass3>()
...
TEST_F(MultiInheritanceTest, ShouldGetServices)
{
    sb::di::ServiceProviderOptions options;
    options.checkServiceGlobalUniqueness = false;
    auto provider = sb::di::ServiceCollection{}
...
TEST_F(MultiInheritanceTest, ShouldGetCastedServicesInOrder)
{
    auto provider = sb::di::ServiceCollection{}
                        .addScoped<TestMultiInherit2Class1, TestMultiInheritClass2>()
                        .addScoped<TestMultiInherit2Class1, TestMultiInheritClass3>()
...
TEST_F(MultiInheritanceTest, ShouldGetServicesInOrderAfterNormalGet)
{
    auto provider = sb::di::ServiceCollection{}
                        .addScoped<TestMultiInherit2Class1, TestMultiInheritClass2>()
                        .addScoped<TestMultiInherit2Class1, TestMultiInheritClass3>()
...
TEST_F(MultiInheritanceTest, ShouldTryCreateService)
{
    sb::di::ServiceProviderOptions options;
    options.checkServiceGlobalUniqueness = false;
    auto provider = sb::di::ServiceCollection{}
...
TEST_F(MultiInheritanceTest, ShouldCreateService)
{
    sb::di::ServiceProviderOptions options;
    options.checkServiceGlobalUniqueness = false;
    auto provider = sb::di::ServiceCollection{}
...
TEST_F(MultiInheritanceTest, ShouldNotCreateServiceInPlace)
{
    sb::di::ServiceProviderOptions options;
    options.checkServiceGlobalUniqueness = false;
    auto provider = sb::di::ServiceCollection{}
...
TEST_F(MultiInheritanceTest, ShouldCreateServices)
{
    sb::di::ServiceProviderOptions options;
    options.checkServiceGlobalUniqueness = false;
    auto provider = sb::di::ServiceCollection{}
...
TEST_F(MultiInheritanceTest, ShouldCreateServicesInOrder)
{
    auto provider = sb::di::ServiceCollection{}
                        .addTransient<TestMultiInherit2Class1, TestMultiInheritClass2>()
                        .addTransient<TestMultiInherit2Class1, TestMultiInheritClass3>()
                        .addTransient<TestMultiInherit2Class1, TestMultiInheritClass4>()
                        .buildServiceProvider();
